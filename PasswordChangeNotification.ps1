...
.EXAMPLE
  ...
  PasswordChangeNotification.ps1 -smtpServer spseu-com.mail.protection.outlook.com -expireInDays 2 -from "IT Service Desk <itsd@spseu.com>" -Logging -LogPath "c:\logFiles" -testing -testRecipient bryan.chapman@spseu.com
#>
param(
...
foreach ($user in $notifyUsers)
{
    ...
    IT Service Desk
    <p><a href=""mailto:itsd@spseu.com""?Subject=Password Expiry Assistance"">itsd@spseu.com</a>
    </font>"
